...
<form  name="board_form" method="post" action="./api/board_modity.php?num=<?=$num?>" enctype="multipart/form-data">
    <h2>게시판 글 수정하기</h2>
    <form class="form-horizontal">
  <div class="form-group">
    <label for="text" class="col-md-6 control-label">제목</label>
    <div class="col-sm-6">
      <input type="text" name="title" class="form-control" id="inputEmail3" placeholder="제목" value="<?=$title?>">
    </div>
  </div>
  <div class="form-group">
    <label for="text" class="col-md-7 control-label">소제목</label>
    <div class="col-sm-7">
      <input type="text" name="subtitle" class="form-control" id="inputEmail3" placeholder="소제목" value="<?=$subtitle?>">
    </div>
  </div>
  <div class="form-group">
    <label for="text" class="col-sm-2 control-label">내용</label>
    <div class="col-sm-7">
      <textarea class="form-control" name="content" rows="10" placeholder="내용"><?=$content?></textarea>
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <button type="submit" class="btn btn-default" onclick="check_input()"/>수정하기</button>
